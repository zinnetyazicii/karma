...
<table class="table table-striped table-bordered table-sm" id="personeltable">
  <thead style=" ">
    <tr>
      <th scope="col"><label id="kartid"></label><br><a href="javascript:void(0)" style="color:white;">KART ID</a></th>
      <th scope="col"><label id="tc"></label><br><a href="javascript:void(0)"style="color:white;">TC</a></th>
      <th scope="col"><label id="ad"></label><br><a href="javascript:void(0)"style="color:white;">AD</a></th>
      <th scope="col"><label id="soyad"></label><br><a href="javascript:void(0)"style="color:white;">SOYAD</a></th>
      <th scope="col"><a href="javascript:void(0)"style="color:white;">BABA ADI</a></th>
	  <th scope="col"><label id="kumanya_tutar"></label><br><a href="javascript:void(0)"style="color:white;">TUTAR</a></th>
      <th scope="col"><a href="javascript:void(0)"style="color:white;">FİRMA</a></th>
      <th scope="col"><a href="javascript:void(0)"style="color:white;">İŞLEM</a></th>
    </tr>
  </thead>
  <tbody>
  <?php
